...
export const Sponsors: React.FC = () => {
  ...
  // Duplicamos el arreglo para hacer el efecto de infinito suave
  const infiniteSponsors = [...sponsors, ...sponsors];

  return (
    <section className="sponsors-section section-padding border-top" style={{ overflow: 'hidden' }}>
      <div className="container" style={{ textAlign: 'center' }}>
        <span className="section-tag label-mono text-green" style={{ marginBottom: '10px', display: 'inline-block' }}>
          // APOYO CONSTANTE
        </span>
        <h2 className="section-title headline-lg" style={{ marginBottom: '15px' }}>
          Gracias a nuestros Patrocinadores
        </h2>
        <p className="section-desc body-md" style={{ maxWidth: '600px', margin: '0 auto 40px auto', color: 'var(--color-on-surface-variant)' }}>
